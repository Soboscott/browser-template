...
/***/ function(module, exports, __webpack_require__) {
	...
	var reviewsEvents = __webpack_require__(12);
	$(function () {
	  authEvents.addHandlers();
	  reviewsEvents.addAjaxHandlers();
	});
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://trail-rater.herokuapp.com/',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n <!-- Developers, why are we using data-id and not just id? -->\n  <div class=\"handlebars-container col-xs-4\">\n    <h2 class=\"reviewData\" data-id=\""
	    ...
	    + "\n  </li>\n  <li>\n  <p>review ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</p>\n</li>\n<li>\n  <button id=\"removereview\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete</button>\n</li>\n  </ul>\n  <button class=\"deletereviewPrompt\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
